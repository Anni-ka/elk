 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.elk.graph.graph.EMapPropertyHolder#getProperties <em>Properties</em>}</li>
 *   <li>{@link org.eclipse.elk.graph.graph.EMapPropertyHolder#getPersistentEntries <em>Persistent Entries</em>}</li>
 * </ul>
 *
 * @see org.eclipse.elk.graph.graph.ElkGraphPackage#getEMapPropertyHolder()
 * @model superTypes="org.eclipse.elk.graph.graph.IPropertyHolder"
 * @generated
 */
public interface EMapPropertyHolder extends EObject, IPropertyHolder {
     ...
     * @see org.eclipse.elk.graph.graph.ElkGraphPackage#getEMapPropertyHolder_Properties()
     * @model mapType="org.eclipse.elk.graph.graph.ElkPropertyToValueMapEntry<org.eclipse.elk.graph.graph.IProperty<?>, org.eclipse.emf.ecore.EJavaObject>" transient="true"
     * @generated
     */
     ...
     * The list contents are of type {@link org.eclipse.elk.graph.graph.ElkPersistentEntry}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see org.eclipse.elk.graph.graph.ElkGraphPackage#getEMapPropertyHolder_PersistentEntries()
     * @model
     * @generated
     */
