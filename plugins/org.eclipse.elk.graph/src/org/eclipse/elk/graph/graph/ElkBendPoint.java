 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.elk.graph.graph.ElkBendPoint#getX <em>X</em>}</li>
 *   <li>{@link org.eclipse.elk.graph.graph.ElkBendPoint#getY <em>Y</em>}</li>
 * </ul>
 *
 * @see org.eclipse.elk.graph.graph.ElkGraphPackage#getElkBendPoint()
 * @model
 * @generated
 */
public interface ElkBendPoint extends EObject {
     ...
     * @see #setX(double)
     * @see org.eclipse.elk.graph.graph.ElkGraphPackage#getElkBendPoint_X()
    ...
    /**
     * Sets the value of the '{@link org.eclipse.elk.graph.graph.ElkBendPoint#getX <em>X</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see #setY(double)
     * @see org.eclipse.elk.graph.graph.ElkGraphPackage#getElkBendPoint_Y()
     * @model default="0.0" required="true"
     * @generated
     */
    double getY();
    ...
    /**
     * Sets the value of the '{@link org.eclipse.elk.graph.graph.ElkBendPoint#getY <em>Y</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
