...
import org.eclipse.elk.graph.graph.EMapPropertyHolder;
import org.eclipse.elk.graph.graph.ElkBendPoint;
...
import org.eclipse.elk.graph.graph.ElkGraphFactory;
...
import org.eclipse.elk.graph.graph.ElkPersistentEntry;
import org.eclipse.elk.graph.graph.ElkPort;
import org.eclipse.elk.graph.graph.ElkShape;
...
public class ElkGraphPackageImpl extends EPackageImpl implements ElkGraphPackage {
     ...
     * @generated
     */
    private EClass elkGraphDataEClass = null;
     ...
     * @see org.eclipse.elk.graph.graph.ElkGraphPackage#eNS_URI
     * @see #init()
     * @generated
     */
     ...
     * @generated
     */
    public EClass getElkGraphData() {
        return elkGraphDataEClass;
    }
     ...
     * @generated
     */
    public EReference getElkGraphElement_Data() {
        return (EReference)elkGraphElementEClass.getEStructuralFeatures().get(1);
    }
    ...
    public EAttribute getElkGraphElement_Identifier() {
        return (EAttribute)elkGraphElementEClass.getEStructuralFeatures().get(2);
    }
    ...
    public void initializePackageContents() {
        ...
        elkGraphDataEClass.getESuperTypes().add(this.getEMapPropertyHolder());
        ...
        op = addEOperation(elkGraphElementEClass, null, "getData", 0, 1, IS_UNIQUE, IS_ORDERED);
        t1 = addETypeParameter(op, "T");
        g1 = createEGenericType(this.getElkGraphData());
