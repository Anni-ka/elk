...
public class ElkGraphSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            ...
            case ElkGraphPackage.ELK_GRAPH_DATA: {
                ElkGraphData elkGraphData = (ElkGraphData)theEObject;
                T result = caseElkGraphData(elkGraphData);
                if (result == null) result = caseEMapPropertyHolder(elkGraphData);
                if (result == null) result = caseIPropertyHolder(elkGraphData);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
     ...
     * @generated
     */
    public T caseElkGraphData(ElkGraphData object) {
        return null;
    }
